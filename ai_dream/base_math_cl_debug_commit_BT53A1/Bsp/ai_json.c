...
void aid_paser_create_Session_json(uint8_t *json_buffer, uint16_t json_size, void *process_handle);
...
json_context_t aijson_context[] =
{
    ...
    {   "deviceInfo",
        "{\"sn\":\"8CF681449CD7\",\"vendor\":{\"devName\":\"\",\"deviceInfo\":{\"productId\":\"D101\",\"manu\":\"DREAM1\",\"blemac\":\"8CF681449CD7\"}}}"
    },
