...
volatile uint16_t adc_value[1][12];
float adc_v[8] = { 0 };
...
void gpio_config(void)
{
    ...
    gpio_init(GPIOC, GPIO_MODE_AIN, GPIO_OSPEED_MAX, GPIO_PIN_1);
	  gpio_init(GPIOC, GPIO_MODE_IN_FLOATING, GPIO_OSPEED_2MHZ, GPIO_PIN_5);
}
...
void adc_config(void)
{
    ...
    adc_channel_length_config(ADC0, ADC_REGULAR_CHANNEL, 12);
